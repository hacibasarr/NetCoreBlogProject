        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutDetals1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AboutDetals2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories", x => x.CtegoryID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommentUD = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => x.CommentUD);
                });
